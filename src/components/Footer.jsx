...
function Footer() {
  return (
    <div className="flex gap-5 w-full h-[150vh] bg-zinc-900 px-10 py-20 font-['FoundersGrotesk, Roboto, sans-serif']">
      <div className="w-1/2 h-full flex flex-col justify-between ">
        <div className="heading">
          <h1 className="text-[8vw] font-semibold tracking-tighter uppercase leading-none -mb-2">
            Eye-
          </h1>
          <h1 className="text-[8vw] font-semibold tracking-tighter uppercase leading-none -mb-2">
            Opening
      ...
      <div className="w-1/2">
        <h1 className="text-[7vw] font-semibold tracking-tighter uppercase leading-none -mb-2">
          Presentation
        </h1>
        <div className="dets1 mt-10 font-['Neue Montreal']">
          S :
          <div className="flex flex-col gap-3 mt-5">
            <a
              href="#"
              className="relative inline-block group text-white w-max"
            >
              Facebook
              <span className="absolute left-0 -bottom-0.5 h-[1px] w-full bg-white origin-left transition-transform duration-500 group-hover:scale-x-0"></span>
            </a>
            <a
              href="#"
              className="relative inline-block group text-white w-max"
        ...
        <div className="dets2 mt-10 font-['Neue Montreal']">
          L :
          <div className="flex flex-row justify-between">
            <div className="flex flex-col gap-2 mt-5">
              ...
              <a
                href="#"
                className="relative mt-7 inline-block group text-white w-max"
              >
                30 Chukarina St
                <span className="absolute left-0 -bottom-0.5 h-[1px] w-full bg-white origin-left transition-transform duration-500 group-hover:scale-x-0"></span>
              </a>
        ...
        <div className="dets3 mt-1 font-['Neue Montreal']">
          E :
          <div className="flex flex-col gap-2 mt-5">
            <a
              href="#"
        ...
        <div className="dets4 mt-20 font-['Neue Montreal']">
          <div className="flex justify-between">
            <a
              href="#"
              className="relative inline-block group text-white/20 w-max"
            >
              © ochi design 2025. Legal Terms
              <span className="absolute left-0 -bottom-0.5 h-[1px] w-full bg-white/20 origin-left transition-transform duration-500 group-hover:scale-x-0"></span>
            </a>
            <a
              href="#"
              className="relative inline-block group text-white/20 w-max"
